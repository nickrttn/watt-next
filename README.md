...
## Use Case
Fleur van Mourik is net begonnen met haar foodtruck genaamd Deli Lama. Fleur reisde door Vietnam en woonde een tijd in Indonesië. Ze nam een aantal heerlijke gerechten mee terug naar Nederland, om deze met de Nederlanders te delen.
...
**Welke input data verzamelen jullie en hoe (welke sensoren, APIs etc):** 

- Onze API vraagt elke seconde om data, prognose en analyse.

 **Hoe wordt deze data omgezet in informatie?** 

- Datavisualisaties per sector, en per stand via onze API.

 **Welke events worden er opgebouwd aan de hand van de informatie en bij wie komen die events terecht?** 

- Uitsturen van verbruiksinformatie naar alle betrokken partijen (bijv foodtrucks) zoals het huidige verbruik, of het huidige verbruik x kilowatt tarief.

 **Welke acties zou een persoon in de doelgroep kunnen nemen aan de hand van dit event?** 
